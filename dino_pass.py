...
parser.add_argument('-n', '--number', type=int, default=10, help='Number of passwords to generate. Simple  Max: 300, Strong Max: 10.')
parser.add_argument('-t', '--type', type=str, default='simple', choices=['simple', 'strong'], help='Password type simple or strong.')
